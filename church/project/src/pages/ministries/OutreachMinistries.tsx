...
import { Music, Globe, HandHeart } from 'lucide-react';
    ...
    <div className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-church-gold font-medium tracking-wider">OUTREACH & SUPPORT</span>
          <h2 className="text-4xl font-bold text-gray-900 mt-4 mb-6">Extending God's Love</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Through our outreach ministries, we extend the love of Christ beyond our walls, 
            reaching those in need and spreading the Gospel through various mediums.
          </p>
        </div>
