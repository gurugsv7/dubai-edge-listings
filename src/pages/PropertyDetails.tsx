                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    {listing.priceDropAmount && (
                      <div className="bg-red-50 p-4 rounded-lg">
                        <p className="text-sm text-red-800 font-medium">Today's Price Drop</p>
                  ...
                  <div className="space-y-4">
                    <div className="bg-green-50 p-4 rounded-lg">
                      <p className="text-sm text-green-800 font-medium">vs Market Average</p>
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <p className="text-sm text-blue-800 font-medium">Expected Monthly Rent</p>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <p className="text-3xl font-bold text-green-600">{listing.roiPercentage}%</p>
                  ...
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-sm text-blue-800">Annual Income</p>
                    <p className="text-xs text-blue-600 mt-1">AED per year</p>
                  </div>
                  ...
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    ...
                    <p className="text-sm text-purple-800">Payback Period</p>
                    <p className="text-xs text-purple-600 mt-1">Years to break even</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <p className="font-medium text-yellow-800">{listing.opportunityReason}</p>
                ...
                {listing.isOffPlan && (
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-medium text-blue-800">Off-Plan</span>
                    </div>
                ...
                {listing.hasPaymentPlan && (
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-medium text-green-800">Payment Plan</span>
                    </div>
                ...
                {listing.isMotivatedSeller && (
                  <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-medium text-orange-800">Motivated Seller</span>
                    </div>
